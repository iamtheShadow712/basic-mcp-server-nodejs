...
class MCPTester {
  ...
  async testListTools() {
    ...
    try {
      ...
      assert(
        response.result.tools.length === 1,
      ...
      assert(
        tool.inputSchema.properties.a,
        "Tool should require parameter 'a'"
      );
      assert(
        tool.inputSchema.properties.b,
        "Tool should require parameter 'b'"
      );
    } finally {
      server.kill();
    }
  ...
  async testAddIntegersValid() {
    ...
    try {
      ...
      assert(
        response.result.content.length === 1,
  ...
  async testAddIntegersNegative() {
    ...
    try {
      ...
      assert(
        response.result.content[0].text === "5",
        "-10 + 15 should equal 5"
      );
    } finally {
      server.kill();
    }
  ...
  async testAddIntegersFloatError() {
    ...
    try {
      ...
      assert(
        response.error.message.includes("integers"),
        "Error should mention integers"
      );
    } finally {
      server.kill();
    }
  ...
  async testAddIntegersStringError() {
    ...
    try {
      ...
      assert(
        response.error.message.includes("numbers"),
        "Error should mention numbers"
      );
    } finally {
      server.kill();
    }
  ...
  async testLargeNumbers() {
    ...
    try {
      ...
      assert(
        response.result.content[0].text === "3000000",
  ...
  async runAllTests() {
    ...
    await this.runTest("Add Integers - Valid", () =>
      this.testAddIntegersValid()
    );
    await this.runTest("Add Integers - Negative Numbers", () =>
      this.testAddIntegersNegative()
    );
    await this.runTest("Add Integers - Zero", () => this.testAddIntegersZero());
    await this.runTest("Add Integers - Float Error", () =>
      this.testAddIntegersFloatError()
    );
    await this.runTest("Add Integers - String Error", () =>
      this.testAddIntegersStringError()
    );
    await this.runTest("Add Integers - Missing Parameter", () =>
      this.testAddIntegersMissingParameter()
    );
